...
export default function App() {
  ...
  // Rollover: if there are no tasks for today, copy bucket tasks into today's date once on load. const rawTasks = useSelector((s: any) => s.tasks?.items ?? []) as unknown;
      ...
      <LocalizationProvider dateAdapter={AdapterDateFns}>
        <Box
          sx={{
            ...
            pb: 6,
            background: dark
              ? "linear-gradient(180deg, #071033 0%, #081026 40%, #071936 100%)"
          ...
          >
            ...
            >
              <IconButton
                ...
                color="inherit"
                aria-label="menu"
                sx={{ mr: 1, bgcolor: "rgba(255,255,255,0.04)" }}
              >
                <MenuIcon />
              </IconButton>
              <Typography
          ...
          <Container sx={{ py: 4, maxWidth: { xs: "100%", md: "lg" } }}>
            ...
            >
              <Box>
                ...
                >
                  <Tab 
                  value="tasks" label="Tasks" aria-controls="panel-tasks"
                  />
                  <Tab
                    value="recommended"
                    label="Recommended"
